...
# 스프라이트(캐릭터) 불러오기
character = pygame.image.load("C:/Users/82102/Desktop/CODE practice/PYTHON/make project/pygame_basic/character.png")
character_size=character.get_rect().size # 이미지의 크기를 구해옴
character_width = character_size[0]  #캐릭터 가로 크기 / 배열의 첫 번째 위치에 있음
character_height = character_size[1] # 캐릭터 세로 크기 / 배열의 두 번째 위치에 있음 
...
#적 캐릭터 생성
enemy = pygame.image.load("C:/Users/82102/Desktop/CODE practice/PYTHON/make project/pygame_basic/enemy.png")
...
while running:
    ...
    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255,255,255))  #render 정보 / 순서대로 (출력할 글자, True, 색상)
